            ...
            children: [
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                    pw.Text(
                      'UniPath — NASC Counselling & Wellness Platform',
                      style: pw.TextStyle(
                          color: grey, fontSize: 9),
                    ),
                    pw.Text(
                      'unipath-nasc.web.app',
                      style: pw.TextStyle(
        ...
        pw.Expanded(
          child: pw.Container(
            ...
            child: pw.Row(
              children: [
                pw.Expanded(
                  flex: score.clamp(0, 30),
                  child: pw.Container(
                    decoration: pw.BoxDecoration(
                      color: color,
                      borderRadius: pw.BorderRadius.horizontal(
                        left: pw.Radius.circular(5),
                      ),
                    ),
                  ),
                ),
                pw.Expanded(
                  flex: (30 - score).clamp(0, 30),
                  child: pw.Container(
                    decoration: pw.BoxDecoration(
                      color: PdfColor.fromHex('#EDE9FE'),
                      borderRadius: pw.BorderRadius.horizontal(
                        right: pw.Radius.circular(5),
                      ),
                    ),
                  ),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildScoreBar('Visual',
                        widget.visualScore, AppColors.primary),
                    const SizedBox(height: 8),
                    _buildScoreBar('Auditory',
                        widget.auditoryScore, AppColors.blue),
                    const SizedBox(height: 8),
                    _buildScoreBar(
                        'Kinesthetic',
                        widget.kinestheticScore,
